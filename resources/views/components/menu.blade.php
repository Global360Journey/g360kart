        ...
        <div class="carousel_top_h_inner">
            ...
            <div class="float-md-left">
                    <div class="top_header_middle">  
                            <div class="col-xs-8 col-xs-offset-2" style="margin-top:10px; margin-left:155px;">
            ...
            <div class="float-md-right">
                <div class="top_header_middle">
                        <!--<a href="#"><i class="fa fa-envelope"></i> Email: <span>support@global360kart.com</span></a>-->
                        <a href="#"><i class="fa fa-user-circle"></i> <B>Login & Signup</b></a>
                        <a href="#"><i class="fa fa-handshake-o"></i> <b>Contact Us</b></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="carousel_menu_inner">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <img src="{{ Voyager::image(setting('site.logo')) }}" alt=""></a>
